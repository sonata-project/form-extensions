...
namespace Sonata\Form\Tests\FlashMessage;

use PHPUnit\Framework\TestCase;
use Sonata\Form\FlashMessage\FlashManager;
    ...
    public function setUp(): void
    {
        ...
        $this->flashManager = $this->getFlashManager([
            'success' => [
                ...
                'my_second_bundle_success' => ['domain' => 'SonataFormBundle'],
            ],
            'warning' => [
                'my_bundle_warning' => ['domain' => 'MyWarningBundle'],
                'my_second_bundle_warning' => ['domain' => 'SonataFormBundle'],
            ],
            'error' => [
                'my_bundle_error' => ['domain' => 'MyErrorBundle'],
                'my_second_bundle_error' => ['domain' => 'SonataFormBundle'],
            ],
        ]);
    }
