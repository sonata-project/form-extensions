...
final class ImmutableArrayTypeTest extends TypeTestCase
{
    ...
    public function testCallback(): void
    {
        ...
        $builder->expects(static::once())->method('add')->with(
            static::callback(static fn (mixed $name): bool => 'ttl' === $name),
            static::callback(static fn (mixed $name): bool => TextType::class === $name),
            static::callback(static fn (mixed $name): bool => $name === [1 => '1'])
        );
